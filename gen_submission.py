...
def encode_folder(
    folder: str,
    save_path: str = "solution.csv",
    public_size: float = 0.3,
    verify: bool = False,
) -> None:
    """
    ...
    for fname in tqdm(files):
        ...
        dct["filename"].append(fname.replace("_x4", ""))
        dct["rle"].append(encoded_img)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--verify",
        action="store_true",
        help="verify encode/decode correctness for each image (slower)",
    )
